  ...
  if (employees.length === 0) {
    return (
      <div className="rounded-lg border border-gray-200 shadow-sm bg-white p-8 sm:p-12 text-center">
        <div className="mx-auto w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-full flex items-center justify-center mb-4 sm:mb-6">
          <svg
